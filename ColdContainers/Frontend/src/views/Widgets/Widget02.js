...
class Widget02 extends Component {
  render() {
    ...
    const blockIcon = function (icon) {
      ...
      //const classes = classNames(icon, padding.icon, 'font-2xl mr-3 float-left');
      return (<i className={classes} style={{backgroundColor: card.color, borderColor: card.color, color: '#fff'}}></i>);
    };
